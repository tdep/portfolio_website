...
import { Profile } from "@/app/(portfolio_frontend)/pages/api/bff";
  ...
  return (
      <div className={styles.container}>
        <Head>
          ...
          <meta name={"description"} content={"Simple demo for simple people"} />
        </Head>
          ...
          {loading ? (
              ...
              <>
                <p className={styles.description}>
                  <strong>Birthdate:</strong> {dayjs(profile.birthdate).format('YYYY-MM-DD')}
                </p>
                <p className={styles.description}>
                ...
                <p className={styles.description}>
                  <strong>Last Seen (Last Received Message):</strong> {dayjs(profile.last_seen).format('YYYY-MM-DD')}
                </p>
                <p className={styles.description}>
